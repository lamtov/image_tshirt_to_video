...
class MyWindow:
    def __init__(self, win):
        ...
        self.list_png = []
        self.file_psd = cur_dir + "/dataset/file_psd.psd"
        ...
        self.et1.insert(END, '600')
        self.et2.insert(END, '9200')
        self.et3.insert(END, '10900')
        self.et4.insert(END, '19100')
    ...
    #         textY2 = (height_origin) / 2 + 30
    #         time_range = (self.end_time_text - self.start_time_text) / 10
    #         while True:
    #             ret, frame = mp4_origin.read()
    #             if ret:
    #                 time_stamp = mp4_origin.get(cv2.CAP_PROP_POS_MSEC)
    #                 if time_stamp >= self.start_time_image and time_stamp <= self.end_time_image:
    ...
    #                     mp4_out.write(frame)
    #                     cv2.waitKey(1)
    #                 elif time_stamp >= self.start_time_text and time_stamp <= self.end_time_text:
    #                     try:
    #                         cur_time = (time_stamp - self.start_time_text)
    ...
    def start_run(self):
        print("dsf")
    #     try:
    #         self.start_time_image = int(self.et1.get())
    #         self.end_time_image = int(self.et2.get())
    #         self.start_time_text = int(self.et3.get())
    #         self.end_time_text = int(self.et4.get())
